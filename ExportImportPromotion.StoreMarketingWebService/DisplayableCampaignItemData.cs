...
#else
	[GeneratedCode("System.Xml", "4.0.30319.1"), DesignerCategory("code"), DebuggerStepThrough, XmlInclude(typeof(DiscountData)), XmlInclude(typeof(AdvertisementData)), XmlType(Namespace = "http://schemas.commerceserver.net/2013/01/MarketingWebService")]
#endif
